...
package com.brian.minio.service;
...
/**
 * @author <a href="mailto:xxxx@outlook.com">xxxx</a>
 */
@Service
@AllArgsConstructor
public class MinioService {
    ...
    public void upload(Path source, InputStream file, String contentType, Multimap<String, String> userMetadata,
            Multimap<String, String> headers) {
